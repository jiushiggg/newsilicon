...
void clear_screen(void)
{
  ...
  EPD_W21_WriteCMD(0x4F);		// Set RAM Y address counter =211
  EPD_W21_WriteDATA(0xD3);
...
//////  EPD_W21_WriteDATA(0x0A);         // Set 130Hz
  ...
  EPD_W21_WriteDATA(0x0C);		// RAM x address end at 0fh(15+1)*8->128    2D13
  EPD_W21_WriteCMD(0x45);		// set RAM y address start/end, in page 37
  EPD_W21_WriteDATA(0x00);		// RAM  y address end at 00h;		    2D13
  EPD_W21_WriteDATA(0x00);		// RAM y address start at FAh;		    2D13	
  EPD_W21_WriteDATA(0xD3);		// RAM y address end at 00h;
  EPD_W21_WriteDATA(0x00);
...
//////  EPD_W21_WriteDATA(0x78);           //-2.6V
  ...
  EPD_W21_WriteDATA(0x60);		//GS1-->GS1
//////  WRITE_LUT();
